    ...
    try {
        ...
        for (const u of users) {
            ...
            tr.innerHTML = `
                ...
                <td class="text-end">
                    <button class="btn btn-sm btn-outline-danger btn-delete-user" data-id="${u.id}" aria-label="Delete user ${u.username}" title="Delete user"><i class="fas fa-trash" aria-hidden="true"></i></button>
                </td>
            `;
