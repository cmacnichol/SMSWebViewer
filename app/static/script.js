    ...
    try {
        ...
        for (const u of users) {
            ...
            tr.innerHTML = `
                ...
                <td class="text-end">
                    <button class="btn btn-sm btn-outline-danger btn-delete-user" aria-label="Delete user ${u.username}" title="Delete user" data-id="${u.id}"><i class="fas fa-trash"></i></button>
                </td>
            `;
